...
namespace Capa_Negocios.ReclamosBodega
{
    public class CN_Comentarios
    {
        ...
        public bool RegistrarComentario(Capa_Entidad.ReclamosBodega.E_Comentarios obj, IFormFile? archivo, string webRootPath)
        {
        ...
        public List<Capa_Entidad.ReclamosBodega.E_Comentarios> Listar(int idReclamo)
        {
            return _daoComentarios.ListarPorReclamo(idReclamo);
        }
    }
}
